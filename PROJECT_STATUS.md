...
## Текущее состояние
- Статус: в разработке
- Последняя итерация: 2026-06-27 (Итерация 2)
- Что работает:
...
- `/api/table-preview` — постраничный просмотр `raw_metrika.visits|hits`, сортировка по `date DESC`, опциональный фильтр `counter_id`
...
- Итерация 3: страница «Воронка» или AI-анализ (по приоритету)
